...
const Card = ({title, images, year, rating}) => {
    ...
    return (
        <div className="w-52 h-960 rounded overflow-hidden shadow-md bg-white">
            <div className='w-full h-72 overflow-hidden'>
            <Image className="w-full h-full object-cover" src={images} width={200} height={200} alt="Sunset in the mountains" />
            </div>
